			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul class="font-11 list-relative list-li-pl-30 list-block list-li-mb-15">
						<li><i class="abs-tl ion-ios-location"></i>Timika, Nawaripi, Kec. Mimika Baru, Kabupaten Mimika, Papua 99971</li>
						<li><i class="abs-tl ion-android-mail"></i>ruslandiaamin@gmail.com</li>
						<li><i class="abs-tl ion-android-call"></i>081240713388</li>
					</ul>
